...
…prev,
causalFactors: prev.causalFactors.map(f =>
f.id === factorId ? { …f, category, subcategory: ‘’ } : f
)
}));
};

const updateCausalFactorSubcategory = (factorId, subcategory) => {
setData(prev => ({
…prev,
causalFactors: prev.causalFactors.map(f =>
f.id === factorId ? { …f, subcategory } : f
)
}));
};
...
{ value: ‘other’, label: ‘Other’, desc: ‘Specify if none of the above categories fit’, color: ‘bg-slate-100 text-slate-800 border-slate-300’, icon: <HelpCircle className="w-4 h-4" /> }
  ...
  const causalFactorSubcategories = {
human_performance: [
{ value: ‘decision_error’, label: ‘Decision Error’, desc: ‘Incorrect choice among alternatives’ },
{ value: ‘skill_based_error’, label: ‘Skill-Based Error’, desc: ‘Slip, lapse, or technique error during routine task’ },
{ value: ‘perceptual_error’, label: ‘Perceptual Error’, desc: ‘Misinterpretation of sensory information’ },
{ value: ‘violation’, label: ‘Violation’, desc: ‘Intentional deviation from rules or procedures’ },
{ value: ‘cognitive_overload’, label: ‘Cognitive Overload’, desc: ‘Mental capacity exceeded by task demands’ },
{ value: ‘situational_awareness’, label: ‘Loss of Situational Awareness’, desc: ‘Failed to recognize or understand situation’ }
],
equipment_systems: [
{ value: ‘design_deficiency’, label: ‘Design Deficiency’, desc: ‘Inadequate design or specification’ },
{ value: ‘material_failure’, label: ‘Material/Component Failure’, desc: ‘Equipment wear, degradation, or failure’ },
{ value: ‘maintenance_inadequate’, label: ‘Maintenance Inadequate’, desc: ‘Insufficient or incorrect maintenance’ },
{ value: ‘quality_defect’, label: ‘Quality/Manufacturing Defect’, desc: ‘Defect introduced during fabrication’ },
{ value: ‘installation_error’, label: ‘Installation/Assembly Error’, desc: ‘Incorrect installation or configuration’ },
{ value: ‘software_error’, label: ‘Software/Control System Error’, desc: ‘Programming, logic, or software defect’ }
],
procedures: [
{ value: ‘procedure_missing’, label: ‘Procedure Not Available’, desc: ‘No procedure exists for the task’ },
{ value: ‘procedure_inadequate’, label: ‘Procedure Inadequate’, desc: ‘Procedure incomplete, unclear, or incorrect’ },
{ value: ‘procedure_not_used’, label: ‘Procedure Not Used’, desc: ‘Procedure existed but was not followed’ },
{ value: ‘procedure_not_updated’, label: ‘Procedure Not Updated’, desc: ‘Procedure did not reflect current conditions’ },
{ value: ‘conflicting_procedures’, label: ‘Conflicting Procedures’, desc: ‘Multiple procedures with contradictory guidance’ },
{ value: ‘procedure_not_accessible’, label: ‘Procedure Not Accessible’, desc: ‘Procedure difficult to obtain or use’ }
],
supervision_leadership: [
{ value: ‘inadequate_oversight’, label: ‘Inadequate Oversight’, desc: ‘Insufficient supervision or monitoring’ },
{ value: ‘poor_planning’, label: ‘Poor Work Planning’, desc: ‘Inadequate job planning or preparation’ },
{ value: ‘resource_allocation’, label: ‘Resource Allocation Issue’, desc: ‘Insufficient people, equipment, or time’ },
{ value: ‘risk_assessment_failure’, label: ‘Risk Assessment Failure’, desc: ‘Hazards not identified or controlled’ },
{ value: ‘conflicting_priorities’, label: ‘Conflicting Priorities’, desc: ‘Production pressure vs safety’ },
{ value: ‘lack_of_enforcement’, label: ‘Lack of Enforcement’, desc: ‘Rules not consistently enforced’ }
],
management_systems: [
{ value: ‘safety_culture’, label: ‘Safety Culture Deficiency’, desc: ‘Organizational attitudes and values toward safety’ },
{ value: ‘policy_inadequate’, label: ‘Policy Inadequate’, desc: ‘Policy missing, unclear, or not enforced’ },
{ value: ‘management_of_change’, label: ‘Management of Change Failure’, desc: ‘Changes not properly assessed or controlled’ },
{ value: ‘audit_inspection’, label: ‘Audit/Inspection Deficiency’, desc: ‘Failed to identify existing problems’ },
{ value: ‘standards_compliance’, label: ‘Standards/Compliance Gap’, desc: ‘Did not meet regulatory or industry standards’ },
{ value: ‘lessons_learned’, label: ‘Lessons Not Learned’, desc: ‘Failed to implement previous recommendations’ }
],
training_competency: [
{ value: ‘training_not_provided’, label: ‘Training Not Provided’, desc: ‘Person not trained for the task’ },
{ value: ‘training_inadequate’, label: ‘Training Inadequate’, desc: ‘Training insufficient or ineffective’ },
{ value: ‘qualification_lacking’, label: ‘Qualification/Certification Lacking’, desc: ‘Person not qualified or certified’ },
{ value: ‘practice_insufficient’, label: ‘Practice/Experience Insufficient’, desc: ‘Inadequate hands-on experience’ },
{ value: ‘competency_not_verified’, label: ‘Competency Not Verified’, desc: ‘Skills not assessed or validated’ },
{ value: ‘refresher_training’, label: ‘Refresher Training Needed’, desc: ‘Skills degraded over time’ }
],
communication: [
{ value: ‘communication_missing’, label: ‘Communication Not Performed’, desc: ‘Required communication did not occur’ },
{ value: ‘communication_unclear’, label: ‘Communication Unclear’, desc: ‘Information ambiguous or misunderstood’ },
{ value: ‘handover_inadequate’, label: ‘Handover Inadequate’, desc: ‘Shift or task handover insufficient’ },
{ value: ‘language_barrier’, label: ‘Language/Cultural Barrier’, desc: ‘Communication hindered by language differences’ },
{ value: ‘coordination_failure’, label: ‘Coordination Failure’, desc: ‘Teams or departments not coordinated’ },
{ value: ‘information_not_shared’, label: ‘Information Not Shared’, desc: ‘Critical information not communicated’ }
],
work_environment: [
{ value: ‘housekeeping’, label: ‘Housekeeping Deficiency’, desc: ‘Poor cleanliness or organization’ },
{ value: ‘lighting_inadequate’, label: ‘Lighting Inadequate’, desc: ‘Insufficient or improper lighting’ },
{ value: ‘noise_distraction’, label: ‘Noise/Distraction’, desc: ‘Excessive noise or interruptions’ },
{ value: ‘temperature_extreme’, label: ‘Temperature Extremes’, desc: ‘Heat, cold, or humidity issues’ },
{ value: ‘workspace_layout’, label: ‘Workspace Layout’, desc: ‘Poor ergonomics or access’ },
{ value: ‘atmospheric_hazard’, label: ‘Atmospheric Hazard’, desc: ‘Toxic, flammable, or oxygen-deficient atmosphere’ }
],
external_factors: [
{ value: ‘weather_conditions’, label: ‘Weather Conditions’, desc: ‘Adverse weather impact’ },
{ value: ‘third_party_action’, label: ‘Third Party Action’, desc: ‘Contractor or external party involvement’ },
{ value: ‘sabotage_vandalism’, label: ‘Sabotage/Vandalism’, desc: ‘Intentional damage or interference’ },
{ value: ‘natural_event’, label: ‘Natural Event’, desc: ‘Earthquake, flood, or other natural occurrence’ },
{ value: ‘regulatory_change’, label: ‘Regulatory Change’, desc: ‘New or changed external requirements’ },
{ value: ‘supply_chain’, label: ‘Supply Chain Issue’, desc: ‘Vendor or supplier problem’ }
],
other: [
{ value: ‘not_categorized’, label: ‘Not Yet Categorized’, desc: ‘Analysis in progress’ },
{ value: ‘multiple_factors’, label: ‘Multiple Contributing Factors’, desc: ‘Complex interaction of causes’ },
{ value: ‘unknown’, label: ‘Unknown/Under Investigation’, desc: ‘Cause not yet determined’ }
]
};
...
<p className="text-sm text-gray-600">Human & Organisational Performance | Human Factors Analysis Tool | Just Culture | IOGP 621</p>
</div>
</div>
<div className="flex gap-3">
...
<button onClick={saveIncident} disabled={saveStatus === ‘saving’} className={`px-4 py-2 rounded flex gap-2 ${ saveStatus === 'saved' ? 'bg-green-600 text-white' : saveStatus === 'error' ? 'bg-red-600 text-white' : 'bg-blue-600 text-white hover:bg-blue-700' }`}>
        ...
        {data.causalFactors.length === 0 ? (
          ...
          <div className="space-y-4">
            {data.causalFactors.map((factor, index) => {
              ...
              const selectedSubcategory = factor.category && causalFactorSubcategories[factor.category]?.find(s => s.value === factor.subcategory);
                    ...
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex-1">
                        ...
                        <div className="grid grid-cols-2 gap-3 mb-3">
                          <div>
                            <label className="block text-xs font-medium mb-1">Primary Category</label>
                            <select
                          ...
                          <div>
                            <label className="block text-xs font-medium mb-1">Secondary Category</label>
                            <select
                              value={factor.subcategory}
                              onChange={(e) => updateCausalFactorSubcategory(factor.id, e.target.value)}
                              className="w-full border rounded px-3 py-2 text-sm"
                              disabled={!factor.category}
                            >
                              <option value="">Select secondary category...</option>
                              {factor.category && causalFactorSubcategories[factor.category]?.map(subcat => (
                                <option key={subcat.value} value={subcat.value}>
                                  {subcat.label} - {subcat.desc}
                                </option>
                              ))}
                            </select>
                          </div>
